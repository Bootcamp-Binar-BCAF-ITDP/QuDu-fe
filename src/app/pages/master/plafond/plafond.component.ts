...
export class PlafondComponent implements OnInit {
  ...
  constructor(
    ...
    this.plafondForm = this.formBuilder.group({
      ...
      maximumAmount: [null as number | null, [Validators.required, Validators.min(0)]],
  ...
  editPlafond(plafond: Plafond): void {
    ...
    this.plafondForm.patchValue({
      ...
      maximumAmount: plafond.maximumAmount,
  ...
  savePlafond(): void {
    ...
    const request: PlafondRequest = {
      ...
      maximumAmount: Number(formValue.maximumAmount ?? 0),
